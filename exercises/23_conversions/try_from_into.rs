...
impl TryFrom<[i16; 3]> for Color {
    ...
    fn try_from(arr: [i16; 3]) -> Result<Self, Self::Error> {
        ...
        if arr[0] < 0 || arr[0] > 255{ return Err(IntoColorError::IntConversion);}
        if arr[1] < 0 || arr[1] > 255{ return Err(IntoColorError::IntConversion);}
        if arr[2] < 0 || arr[2] > 255{ return Err(IntoColorError::IntConversion);}
...
impl TryFrom<&[i16]> for Color {
    ...
    fn try_from(slice: &[i16]) -> Result<Self, Self::Error> {
        ...
        if slice[0] < 0 || slice[0] > 255{ return Err(IntoColorError::IntConversion);}
        if slice[1] < 0 || slice[1] > 255{ return Err(IntoColorError::IntConversion);}
        if slice[2] < 0 || slice[2] > 255{ return Err(IntoColorError::IntConversion);}
